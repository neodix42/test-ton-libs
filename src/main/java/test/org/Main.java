...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 0) {
            ...
            System.out.println("Specified path to tonlib or emulator: " + args[0]);
            ...
            if (args.length == 1) { //test tonlib only
                ...
                TxEmulator txEmulator = TxEmulator.builder()
                        ...
                        .verbosityLevel(TxVerbosityLevel.WITH_CELL_HASH_AND_OFFSET)
                        .build();
            ...
            System.out.println("Usage: test-ton4j.jar <name in current dir or absolute path to tonlibjson>");
            System.out.println("Usage: test-ton4j.jar <name in current dir or absolute path to tonlibjson and emulator>");
        }
    }
    ...
    private static void testTvmEmulator(Tonlib tonlib, String absolutePathEmulator) {
        try {
            ...
            WalletV4R2 walletV4R2 = WalletV4R2.builder().tonlib(tonlib).keyPair(keyPair).walletId(42).build();
    ...
    private static void testTonlib(Tonlib tonlib) {
        ...
        try {
            ...
            BlockTransactions blockTransactions = tonlib.getBlockTransactions(masterChainInfo.getLast(), 10);
            System.out.println(blockTransactions);

            String account = "-1:" + Utils.base64ToHexString(blockTransactions.getTransactions().get(0).getAccount());
            ...
            BlockIdExt lookupBlock = tonlib.lookupBlock(masterChainInfo.getLast().getSeqno(), masterChainInfo.getLast().getWorkchain(), masterChainInfo.getLast().getShard(), 0);
            System.out.println(lookupBlock);

            SmcLibraryResult libraryResult = tonlib.getLibraries(Collections.singletonList("wkUmK4wrzl6fzSPKM04dVfqW1M5pqigX3tcXzvy6P3M="));
    ...
    private static void testTxEmulatorWalletV5ExternalMsgSimplified(TxEmulator txEmulator) {
        ...
        Cell codeCell = Cell.fromBoc("");
    ...
    private static void testTvmEmulatorSendExternalMessage(TvmEmulator tvmEmulator, WalletV4R2 walletV4R2) {
        ...
        tvmEmulator.setC7(address, Instant.now().getEpochSecond(), Utils.toNano(1).longValue(), randSeedHex, null);
        ...
        tvmEmulator.runGetSeqNo().longValue();
